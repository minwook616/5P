...
export default function NewPost() {
  ...
  return (
    <div className="space-y-8">
      ...
      <div>
        <div className="text-[10px] uppercase tracking-[0.4em] fp-mono text-[var(--text-mute)] mb-2">Compose</div>
      ...
      <form onSubmit={submit} className="space-y-8">
        <div>
          <label className="block text-[10px] uppercase tracking-[0.3em] fp-mono text-[var(--text-mute)] mb-2">Title</label>
          <input
        ...
        <div>
          <label className="block text-[10px] uppercase tracking-[0.3em] fp-mono text-[var(--text-mute)] mb-2">Body</label>
          <textarea
          ...
          />
          <div className="mt-2 text-right text-[10px] fp-mono text-[var(--text-mute)]">{content.length}/3000</div>
        </div>
